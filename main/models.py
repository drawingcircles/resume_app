...
<<<<<<< HEAD
        ordering = ["-date"]
    link = models.CharField(max_length=100, null=False, blank=True, default='')
=======
        ordering = ["date"]
...
class Certificate(models.Model):
    ...
    link = models.CharField(max_length=100, null=False, blank=True, default='jacobmolinar.herokuapp.com')
